          ...
          <CardContent>
            ...
            {audioUrl && (
              <div className="mt-4 space-y-2">
                <audio controls className="w-full" aria-label={`Audio for episode: ${episodeTitle}`}>
        ...
        <Dialog open={showAddContentDialog} onOpenChange={setShowAddContentDialog}>
          <DialogContent aria-describedby="add-content-description">
            <DialogHeader>
              ...
              <DialogDescription id="add-content-description">Add content to generate your podcast from</DialogDescription>
            </DialogHeader>
            <div className="space-y-4 mt-4">
              ...
              {sourceType === "url" ? (
                ...
                <div>
                  <Label htmlFor="text-content" className="mb-1">Text Content</Label>
                  <Textarea
                    id="text-content"
                    className="h-32"
                    value={textContent}
